...
const people = [
  {
    ...
    about:
      "Est tempor sint sit velit aliqua. Incididunt nisi voluptate deserunt tempor sint ut eu aute est voluptate ipsum. Cupidatat nulla laboris in ullamco ullamco nostrud ut consequat esse. Irure et Lorem adipisicing excepteur. Consequat dolor elit nostrud irure officia. Ut consectetur officia non sint.\r\n",
  ...
  },
  {
    ...
    about:
      "Culpa dolore in ea quis nisi magna ea sunt irure id ex. In ut consectetur consectetur commodo velit ullamco ipsum veniam. Velit ut id tempor exercitation sint. Qui anim consequat quis consequat veniam eu ipsum exercitation nostrud qui esse laboris do. Laboris nulla irure sint enim cillum ea est in. Cupidatat dolor esse proident et eiusmod in ut fugiat eiusmod sint et cupidatat esse. Aliqua nostrud esse ex pariatur non esse non cupidatat culpa irure occaecat officia.\r\n",
  ...
  },
  {
    ...
    about:
      "Labore voluptate cupidatat consequat minim. Non mollit labore velit do ut exercitation sunt do consectetur officia. Aliqua deserunt fugiat ex ad cillum consectetur sint consequat quis mollit aliqua dolor reprehenderit. Sint labore aliquip labore eiusmod elit veniam sit proident officia.\r\n",
  ...
  },
  {
    ...
    about:
      "Labore aliqua sit est esse enim. Dolore amet Lorem proident Lorem adipisicing. Veniam sit minim eu nulla exercitation nulla. Ullamco fugiat aute nulla aute quis sit dolor ex excepteur Lorem enim sunt excepteur. Minim ipsum anim officia laborum cillum esse. Nulla aliqua sit veniam est aliqua ullamco reprehenderit. Pariatur ad pariatur pariatur incididunt dolor anim mollit commodo ad quis ut.\r\n",
...
app.get("/filterNumbers", (req, res) => {
  const resultNumber = people.filter((person) => person.age === 24);
  res.send([{ Phone: resultNumber[0].phone }]);
});
...
// total balances of all the users combined
// how many men and how many women are there of our users
// the total companies
// the name of all the companies
// and a list of all the addresses for each user in our db
app.get("/totalBal", (req, res) => {
  const listBal = [];
  let sum = 0;
  for (const person of people) {
    listBal.push(person.balance);
  }
  for (let i = 0; )
  listBal.reduce((a, b) => a + b, 0);
  res.send(listBal);
});
